		...
		<div class="zck">
			<div class="inputstyle">
				<div class="inputlable">用户名：
					<input type="text" value="" name="j_username" id="userName" onFocus="this.select();" title="请您输入用户名"/>
					<div id="ts" style="z-index:1;">
					</div>
				</div>

			    <div class="inputlable">密　码：
					<input type="password" value="" name="j_password" id="password" onfocus="$('#ts').css('display','none');this.select();"
